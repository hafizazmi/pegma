...
function trim_tarikh3($tarikh){
	...
	if($tarikh_temp[1] == '02') $tarikh_eja = "Febuary";
...
}function trim_tarikh4BM($tarikh){
		$tarikh_temp = explode("-",substr($tarikh,0,10));
		
	if($tarikh_temp[1] == '01') $tarikh_eja = "Januari";
	if($tarikh_temp[1] == '02') $tarikh_eja = "Februari";
...
function trim_tarikh5($tarikh){
		$tarikh_temp = explode("-",substr($tarikh,0,10));
	
	$tarikh_fix = $tarikh_temp[2];
	return $tarikh_fix;

}
function trim_tarikh6($tarikh){
		$tarikh_temp = explode("-",substr($tarikh,0,10));
		
	if($tarikh_temp[1] == '01') $tarikh_eja = "Jan";
	if($tarikh_temp[1] == '02') $tarikh_eja = "Feb";
	if($tarikh_temp[1] == '03') $tarikh_eja = "Mar";
	if($tarikh_temp[1] == '04') $tarikh_eja = "Apr";
	if($tarikh_temp[1] == '05') $tarikh_eja = "May";
	if($tarikh_temp[1] == '06') $tarikh_eja = "Jun";
	if($tarikh_temp[1] == '07') $tarikh_eja = "Jul";
	if($tarikh_temp[1] == '08') $tarikh_eja = "Aug";
	if($tarikh_temp[1] == '09') $tarikh_eja = "Sep";
	if($tarikh_temp[1] == '10') $tarikh_eja = "Oct";
	if($tarikh_temp[1] == '11') $tarikh_eja = "Nov";
	if($tarikh_temp[1] == '12') $tarikh_eja = "Dec";
	
	
	$tarikh_fix = $tarikh_eja;
	return $tarikh_fix;

}
function trim_tarikh7($tarikh){
		$tarikh_temp = explode("-",substr($tarikh,0,10));
...
function month2($bulan)
{
	if($bulan == '01') $tarikh_eja = "JANUARY";
	if($bulan == '02') $tarikh_eja = "FEBRUARY";
	if($bulan == '03') $tarikh_eja = "MARCH";
	if($bulan == '04') $tarikh_eja = "APRIL";
	if($bulan == '05') $tarikh_eja = "MAY";
	if($bulan == '06') $tarikh_eja = "JUNE";
	if($bulan == '07') $tarikh_eja = "JULY";
	if($bulan == '08') $tarikh_eja = "AUGUST";
	if($bulan == '09') $tarikh_eja = "SEPTEMBER";
	if($bulan == '10') $tarikh_eja = "OCTOBER";
	if($bulan == '11') $tarikh_eja = "NOVEMBER";
	if($bulan == '12') $tarikh_eja = "DECEMBER";
	return $tarikh_eja;
}
