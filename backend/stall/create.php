...
if ( !empty($_POST)) {
    ...
    $valid = true;
    if (empty($name)) {
        $stallNameError = 'Sila masukkan kata name';
        $valid = false;
    }
    ...
    <div class="card card-block">
        ...
        <form class="form-horizontal" action="create.php" method="post">
            <div class="form-group row">
                <div class="control-group <?php echo !empty($stallNameError)?'error':'';?>">
                    ...
                    <div class="col-sm-4 controls">
                        ...
                        <?php if (!empty($stallNameError)): ?>
                            <span class="help-inline"><?php echo $stallNameError;?></span>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
